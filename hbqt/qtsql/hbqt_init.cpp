/*
 * $Id: hbqt_init.cpp 4 2012-09-29 19:42:37Z bedipritpal $
 */
...
HB_CALL_ON_STARTUP_BEGIN( _hbqtsql_init_ )
   hb_vmAtInit( hbqt_lib_init, NULL );
   hb_vmAtExit( hbqt_lib_exit, NULL );
HB_CALL_ON_STARTUP_END( _hbqtsql_init_ )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup _hbqtsql_init_
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( _hbqtsql_init_ )
   #include "hbiniseg.h"
#endif
